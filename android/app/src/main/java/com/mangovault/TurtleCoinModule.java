...
import com.mangovault.BuildConfig;
...
public class TurtleCoinModule extends ReactContextBaseJavaModule {
    ...
    private void getWalletSyncDataImpl(
        ...
        try
        {
            ...
            if (BuildConfig.APPLICATION_ID == "com.mangovault" && BuildConfig.VERSION_CODE >= 1) {
                connection.setRequestProperty("User-Agent", "mangovault-da-greatest!");
            } else {
